    ...
    <div class="main">
      ...
      <div class="condition">
        <ul class="cate-list">
          ...
          <li :class="category==item.id?'this':''" @click="category=item.id" v-for="item in category_list">{{item.name}}</li>
      ...
      <div class="course-list">
        <div class="course-item" v-for="course in courses_list">
          ...
          <div class="course-info">
            ...
            <ul class="lesson-list">
              <li v-for="lesson in course.lesson_list"><span class="lesson-title">0{{lesson.lesson}} | {{lesson.name}}</span> <span class="free">免费</span></li>
            </ul>
      ...
      methods:{
          ...
          get_course(){
              ...
              this.$axios.get(`${this.$settings.Host}/course/`,{
                  ...
                  this.courses_list = response.data.results;
